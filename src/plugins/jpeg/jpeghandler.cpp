...
void JpegHandlerPrivate::applyExifOrientation(QImage *image)
{
...
ImageOptionsSet JpegHandlerPlugin::supportedOptions(const QMimeType &mimeType, const QByteArray &subType) const
{
    Q_UNUSED(mimeType);
    Q_UNUSED(subType);
    return {
